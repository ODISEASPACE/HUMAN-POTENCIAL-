...
<body>
    ...
    <main>
        <div class="header-dash">
            <h1>Proyectos y Fuentes</h1>
            <p>Gestión de investigación, logros y líneas de tiempo.</p>
        </div>
        <div class="card">
            <h3>Línea de producción</h3>
            <p style="color: var(--text-muted); margin-top: 10px;">Aquí se conectarán las bases de datos de estudio y desarrollo.</p>
        </div>
    </main>
</body>
</html>
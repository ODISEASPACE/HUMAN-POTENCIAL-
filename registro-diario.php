...
<body>
    ...
    <main>
        <div class="header-dash">
            ...
            <p>Seguimiento de rutinas, eventos, estado de ánimo y finanzas.</p>
        </div>
        <div class="card">
            <h3>Gestor de rutinas</h3>
            <p style="color: var(--text-muted); margin-top: 10px;">Aquí irá el temporizador y el tracker de hábitos diarios.</p>
        </div>
    </main>
</body>
</html>
...
<head>
    ...
    <style>
        ...
        /* CLASES COMPARTIDAS (Se mantienen porque los modales y controles las usan) */
...
<body>
    ...
    <script>
        ...
        async function saveProject() {
            ...
            if(!title || !category) {
                // Alerta nativa temporal si la IA no está disponible en la vista
                alert('> [ADVERTENCIA] Nodos sin título o categoría son inestables. Operación abortada.');
                return;
            }
            ...
            try {
                ...
                if (result.status === 'success') {
                    ...
                    alert(`> [ERROR SQL] ${result.message}`);
                }
            } catch (error) {
                alert(`> [FALLA DE SISTEMA] No se pudo contactar al controlador.`);
            }
        }
        ...
        async function deleteProject(id) {
            ...
            try {
                ...
                alert(`> [FALLA DE SISTEMA] No se pudo completar la purga.`);
            }
        }
    </script>
</body>
